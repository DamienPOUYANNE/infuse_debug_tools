#ifndef ASN1BITSTREAMDATASETCLEANER_H
#define ASN1BITSTREAMDATASETCLEANER_H
...
namespace infuse_debug_tools {
    class Asn1BitstreamDatasetCleaner
    {
        public:
            ...
            /**
                Constructor
            */
            Asn1BitstreamDatasetCleaner();

            /**
                Process stereo matching between two images and calculate the disparity image.

                @param image pair to compare
                @param percentage of paired pixels
            */
            void process_stereo_matching(asn1SccFramePair& in_frame_pair, double & percentage);
            ...
            */
            void process_stereo_rectification(asn1SccFramePair& in_original_stereo_pair, cv::Mat & out_rect_left, cv::Mat & out_rect_right);

            /**
                Process inter cameras rotation convert from quaternion to Euler

                @param image pair to extract
                @param roll
                @param pitch
                @param yaw
            */
            void process_quaternion_convert(asn1SccFramePair& in_frame_pair, double & roll, double & pitch, double & yaw);
            /**
                Connect image topic
            ...
            */
            void image_callback (const infuse_msgs::asn1_bitstream::Ptr& msg, const ros::Publisher &pub_asn1);
        ...
        private:
            ...
            int nb_messages = 0;
            int nb_messages_cleaned = 0;
    };
} // infuse_debug_tools

#endif // ASN1BITSTREAMDATASETCLEANER_H
